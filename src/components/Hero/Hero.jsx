...
import { FedeRight } from '../../utillty/animation';
      ...
      md:grid-cols-2 min-h-[650px] relative">
        ...
        py-14 md:py-10 relative z-10'>
            ...
            lg:max-w-[400px] '>
                ...
                initial="hidden"
                animate="visible"
                className='text-2xl tracking-wide'>Order Now Frash Helthy Life</motion.p>
                <motion.p
                 variants={FedeRight(1.2)}
                initial="hidden"
                animate="visible"
                className='text-gray-400'>Halthy and yummy food fresh moring 
                  breakfast Eat Daily good health mind
                  Oder now and get 20% off on your first order  
                </motion.p>
                {/* butoon section */}
                   <motion.div 
